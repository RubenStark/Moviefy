...
def userProfile(request, pk):
    ...
    context = {'profile': profile, 'skills':skills, 'subscribed':subscribed}
...
def userAccount(request):
    ...
    context = {'profile': profile, 'skills':skills, 'projects':projects, 'subscriptions':subscriptions}
...
def subscriptions(request):
    ...
    subscribed = []
    for sub in subs:
        subscribed.append(sub.subscribed)
    print(subscribed)

    context = {'subscribed': subscribed, 'page': page}
